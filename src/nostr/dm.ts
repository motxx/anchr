...
import type { OracleDMPayload, PreimageDMPayload, RejectionDMPayload } from "./events";
export type { OracleDMPayload } from "./events";
...
/**
 * Parse an Oracle DM (preimage or rejection).
 */
