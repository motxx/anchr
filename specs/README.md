...
| [Conditional Swap](conditional-swap.md)           | Conditional settlement design material under review. Issue #0093 decides whether any part remains an active public spec.                                          |
...
| FROST DKG + threshold P2PK helpers                 | `packages/sdk/src/payments/frost-*` and `packages/sdk/src/adapters/oracle-*` | DKG flow, threshold signing, and helper wiring are SDK implementation details unless promoted by #0094.   |
