...
- 2026-06-13: **Decision: keep `p2pk_frost` in v0 and complete it.** Fixed in
  ...
  - **PROT-05 + PROT-06** (mint-spendable group-signature message + Provider
    redeem path) need a wire/spec extension and were split into issue 0154;
    this issue stays pending until 0154 closes.
  - 2026-06-13: issue 0154 closed the remaining FROST P2PK settlement gap:
