...
payloads keyed by the request's schema URI, per the model decided in 0143.
...
- This is the load-bearing blocker for the "anyone can define a schema"
  premise; see the 0143 decision record.
...
- Introduce the schema-scoped payload fields decided in 0143.
