...
deno test --allow-all apps/two-party-binary-bet/
...
apps/two-party-binary-bet/scripts/frost-dkg-bootstrap.ts --threshold 2 --total 3
apps/two-party-binary-bet/scripts/frost-oracle-cluster.ts
```
